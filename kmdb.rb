...
roles = [
  { movie: batman_begins, actor: christian_bale, character_name: "Bruce Wayne" },
  { movie: batman_begins, actor: michael_caine, character_name: "Alfred" },
  { movie: batman_begins, actor: liam_neeson, character_name: "Ra's Al Ghul" },
  { movie: batman_begins, actor: katie_holmes, character_name: "Rachel Dawes" },
  { movie: batman_begins, actor: gary_oldman, character_name: "Commissioner Gordon" },
  { movie: dark_knight, actor: christian_bale, character_name: "Bruce Wayne" },
  { movie: dark_knight, actor: heath_ledger, character_name: "Joker" },
  { movie: dark_knight, actor: aaron_eckhart, character_name: "Harvey Dent" },
  { movie: dark_knight, actor: michael_caine, character_name: "Alfred" },
  { movie: dark_knight, actor: maggie_gyllenhaal, character_name: "Rachel Dawes" },
  { movie: dark_knight_rises, actor: christian_bale, character_name: "Bruce Wayne" },
  { movie: dark_knight_rises, actor: gary_oldman, character_name: "Commissioner Gordon" },
  { movie: dark_knight_rises, actor: tom_hardy, character_name: "Bane" },
  { movie: dark_knight_rises, actor: joseph_gordon_levitt, character_name: "John Blake" },
  { movie: dark_knight_rises, actor: anne_hathaway, character_name: "Selina Kyle" },
]
